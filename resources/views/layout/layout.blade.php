    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <ul class="navbar-nav mr-auto">
          <li class="nav-item">
            <a class="nav-link" href="{{url('archive/couple')}}">គូស្នេហ៍
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{url('archive/broken')}}">ខូចចិត្ត
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{url('archive/marry')}}">អាពាហ៍ពិពាហ៍
            </a>
          </li>
        </ul>
